...
def main():
    ...
    #print(f"N={args.N}  variant={args.variant}  target={args.target}")
    adaptive_layer_search(8, 'g','ground',
                           k_max=3, tol=5e-3,
                           n_restarts=2, seed=23)
    adaptive_layer_search(8, 're','ground',
                        k_max=3, tol=5e-3,
                        n_restarts=2, seed=23)
    adaptive_layer_search(8, 'im','ground',
                        k_max=3, tol=5e-3,
                        n_restarts=2, seed=23)
